...
def get_items(keyword):
    ...
    URL = 'https://shop.wegmans.com/api/v2/store_products?ads_enabled=true&ads_pagination_improvements=false&allow_autocorrect=true&limit=60&offset=0&search_is_autocomplete=false&search_provider=ic&search_term=' + \
        keyword+'&secondary_results=true&sort=rank&unified_search_shadow_test_enabled=false'
